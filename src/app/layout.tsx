...
const SITE_URL = "https://osint-platform.local";
const SITE_NAME = "OSINT Platform";
const SITE_TITLE = "OSINT Platform — Open Source Intelligence Platform | Live Flight Tracking, CCTV, OSINT Tools & More";
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | OSINT Platform Intelligence",
  },
  ...
  keywords: [
    ...
    // Brand
    "osint", "osintplatform", "osint-platform.local",
  ],
  authors: [{ name: "OSINT Platform Project", url: SITE_URL }],
  creator: "OSINT Platform Project",
  publisher: "OSINT Platform Project",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "OSINT Platform — The Open-Source Palantir Alternative | Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "OSINT Platform — Open Source Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ OSINT Platform — Open Source Palantir Alternative | Live Tracking + OSINT Tools",
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "OSINT Platform",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "OSINT Platform — OSINT Toolkit & Intelligence Platform",
  alternateName: ["OSINT Platform", "OSINT PlatformAI", "OSINT Platform OSINT"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
  ...
  return (
    <html lang="en" dir="ltr">
      ...
      <body className="antialiased">
        <ErrorBoundary name="OSINT Platform Core">
          {children}
        </ErrorBoundary>
      </body>
    </html>
