...
/**
 * Thin proxy to the OSINT Platform Intelligence Layer (osint-intel).
 *
 * In Docker: fetches from http://osint-intel:4000/resolve
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[OSINT Platform] Intel proxy error:', e instanceof Error ? e.message : e);
    return NextResponse.json(
