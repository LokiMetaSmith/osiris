/**
 * ═══════════════════════════════════════════════════════════════
 *  OSINT Platform — AI Intelligence Engine
...
const SYSTEM_PROMPT = `You are OSINT Platform Intelligence Analyst — a senior, elite intelligence analyst embedded within the OSINT Platform Global Intelligence Platform. You operate at the level of a Palantir Forward Deployed Engineer crossed with a CIA PDB (Presidential Daily Brief) analyst.
...
You have access to the live intelligence context of the OSINT Platform platform. Analyze it with precision.`;

const BRIEFING_PROMPT = `Generate a comprehensive OSINT Platform Daily Intelligence Briefing based on the current operational data. Structure it as follows:

## OSINT Platform INTELLIGENCE BRIEFING
